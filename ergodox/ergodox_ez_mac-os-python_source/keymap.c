...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LSPO,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_MINUS,                                       KC_EQUAL,       KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RSPC,
    KC_MEDIA_PREV_TRACK,KC_MEDIA_PLAY_PAUSE,KC_MEDIA_NEXT_TRACK,TT(2),          TT(1),                                                                                                          TT(1),          KC_RGUI,        KC_RALT,        KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,
                                                                                                    KC_CAPSLOCK,    KC_TRANSPARENT, ST_MACRO_0,     ST_MACRO_1,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_LGUI,        KC_BSPACE,      KC_LALT,        KC_TRANSPARENT, KC_ENTER,       KC_SPACE
  ),
  [1] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_MEDIA_PLAY_PAUSE,                                KC_TRANSPARENT, KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F12,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_7,           KC_8,           KC_9,           KC_TRANSPARENT, KC_MEDIA_NEXT_TRACK,                                KC_AUDIO_VOL_UP,KC_TRANSPARENT, KC_PGUP,        KC_HOME,        KC_TRANSPARENT, KC_TRANSPARENT, KC_F11,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_0,           KC_0,           KC_0,                                                                                                           TO(0),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    ...
                                                                                    TO(0),          TO(0),          HSV_127_255_255,KC_TRANSPARENT, KC_BSPACE,      KC_SPACE
  ),
