...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    MO(2),          KC_MAC_CUT,     KC_MAC_COPY,    KC_MAC_PASTE,   MO(1),                                                                                                          MO(1),          ST_MACRO_1,     KC_TRANSPARENT, KC_TRANSPARENT, MO(2),
                                                                                                    ST_MACRO_0,     KC_DELETE,      ST_MACRO_2,     ST_MACRO_3,
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_7,           KC_8,           KC_9,           KC_TRANSPARENT, KC_MEDIA_NEXT_TRACK,                                KC_AUDIO_VOL_UP,ST_MACRO_4,     KC_PGUP,        KC_HOME,        ST_MACRO_5,     KC_TRANSPARENT, KC_F12,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT,                                                                 ST_MACRO_6,     KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_7,     KC_TRANSPARENT, KC_MEDIA_PLAY_PAUSE,
