...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LSPO,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           LCTL_T(KC_ESCAPE),                                KC_EQUAL,       KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RSPC,
    MO(2),          KC_MAC_CUT,     KC_MAC_COPY,    KC_MAC_PASTE,   MO(1),                                                                                                          MO(1),          ST_MACRO_2,     KC_TRANSPARENT, KC_TRANSPARENT, MO(2),
                                                                                                    ST_MACRO_0,     KC_DELETE,      ST_MACRO_3,     ST_MACRO_4,
                                                                                                                    ST_MACRO_1,     KC_RALT,
                                                                                    KC_LGUI,        KC_BSPACE,      KC_LALT,        KC_RGUI,        KC_ENTER,       KC_SPACE
  ),
  [1] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_MEDIA_PLAY_PAUSE,                                KC_AUDIO_MUTE,  KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_7,           KC_8,           KC_9,           KC_TRANSPARENT, KC_MEDIA_NEXT_TRACK,                                KC_AUDIO_VOL_UP,ST_MACRO_5,     KC_PGUP,        KC_HOME,        ST_MACRO_6,     KC_TRANSPARENT, KC_F12,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_0,           KC_0,           KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT,                                                                 ST_MACRO_7,     KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_8,     KC_TRANSPARENT, KC_MEDIA_PLAY_PAUSE,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_2:
    if (record->event.pressed) {
      SEND_STRING(SS_RALT(SS_TAP(X_SPACE)));
