...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    MO(2),          KC_MAC_CUT,     KC_MAC_COPY,    KC_MAC_PASTE,   MO(1),                                                                                                          MO(1),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(2),
                                                                                                    ST_MACRO_0,     KC_DELETE,      KC_RGUI,        ST_MACRO_1,
                                                                                                                    KC_LALT,        KC_RALT,
                                                                                    KC_LGUI,        KC_BSPACE,      LCTL_T(KC_ESCAPE),RCTL_T(KC_ESCAPE),KC_ENTER,       KC_SPACE
  ),
  [1] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_MEDIA_PLAY_PAUSE,                                KC_AUDIO_MUTE,  KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_7,           KC_8,           KC_9,           KC_TRANSPARENT, KC_MEDIA_NEXT_TRACK,                                KC_AUDIO_VOL_UP,ST_MACRO_2,     KC_PGUP,        KC_HOME,        ST_MACRO_3,     KC_TRANSPARENT, KC_F12,
